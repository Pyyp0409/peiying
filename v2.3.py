...
# Update payment processing to include new payment methods
...
# The rest of the functions remain similar but with the new payment methods integrated
# [Previous functions for other portals remain the same, just ensure they use the updated payment methods]
