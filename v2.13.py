...
<style>
    ...
    .main-header {
        ...
        padding: 2rem;
        border-radius: 15px;
        background: linear-gradient(145deg, var(--soft-mint), var(--light-blue));
        box-shadow: 0 8px 25px rgba(25, 116, 126, 0.15);
    ...
    .card {
        ...
        padding: 1.8rem;
        border-radius: 12px;
        box-shadow: 0 4px 15px rgba(25, 116, 126, 0.1);
        margin-bottom: 1.5rem;
    ...
    .login-container {
        ...
        padding: 3rem;
        border-radius: 15px;
        box-shadow: 0 10px 30px rgba(25, 116, 126, 0.15);
        border: 2px solid var(--dark-cyan);
        margin-bottom: 2rem;
    }
    
    .demo-account {
        background: linear-gradient(135deg, var(--light-blue) 0%, var(--dark-cyan) 100%);
        color: var(--dark-navy);
        padding: 1.2rem;
        border-radius: 10px;
        margin: 0.8rem 0;
        box-shadow: 0 3px 10px rgba(25, 116, 126, 0.2);
        border: 1px solid var(--platinum);
    }
    ...
    .sidebar-header {
        background: linear-gradient(135deg, var(--dark-navy) 0%, var(--cerulean) 100%);
        padding: 1.5rem;
        border-radius: 12px;
        color: white;
        text-align: center;
        margin-bottom: 1rem;
        box-shadow: 0 4px 15px rgba(25, 116, 126, 0.2);
    }
    
    .stButton button {
        background: linear-gradient(135deg, var(--dark-cyan) 0%, var(--cerulean) 100%);
        color: white;
        border: none;
        border-radius: 8px;
    ...
    .stButton button:hover {
        background: linear-gradient(135deg, var(--cerulean) 0%, var(--dark-cyan) 100%);
        color: white;
        transform: translateY(-2px);
        box-shadow: 0 4px 12px rgba(25, 116, 126, 0.2);
    }
    ...
    .elegant-cover {
        ...
        color: white;
        margin-bottom: 3rem;
        box-shadow: 0 15px 35px rgba(45, 27, 105, 0.4);
        position: relative;
        overflow: hidden;
    }
    ...
    if st.session_state.get('show_password_recovery', False):
        with st.form("password_recovery"):
            ...
            if st.form_submit_button("Reset Password"):
                # Validate inputs
                if not recovery_email or not recovery_role or not new_password or not confirm_password:
                    ...
                    for user in st.session_state.registered_users:
                        if user["email"] == recovery_email and user["role"] == recovery_role:
                            ...
                            user_found = True
                            # Log the activity
                            log_activity("System", "Password Reset", 
                                       f"Password reset for {recovery_email} ({recovery_role})")
                            break
...
# Run the application
if __name__ == "__main__":
>>>>>>> a68cbc779899d790fe83c4dec7b1da1c8a9fee06
    main()